...
import com.example.ultrabrowser.util.SystemUiHider;
...
public class Flash_screen_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnstart=(Button)findViewById(R.id.dummy_button);
		...
		new Handler().postDelayed( new Runnable() {
			public void run() {
				...
				Intent i=new Intent(Flash_screen_Activity.this,Home_activity.class);
				startActivity(i);
				finish();
			}
		}, SPLASH_TIME_OUT);
